<div class="unipayment-advertising" data-unipayment-advertising>
    {if $unipayment_advertising.is_mobile}
        <button type="button" class="unipayment-advertising__float"
            {if $unipayment_advertising.backurl}data-unipayment-advertising-open="{$unipayment_advertising.backurl|escape:'htmlall':'UTF-8'}"
            {/if}>
        ...
        <div id="unipayment-advertising-panel" class="unipayment-advertising__panel" role="dialog"
            ...
            <div class="unipayment-advertising__body">
                ...
                <img class="unipayment-advertising__picture" alt=""
                    {if $unipayment_advertising.picture_url}src="{$unipayment_advertising.picture_url|escape:'htmlall':'UTF-8'}"
                    {/if}>
                ...
                <div class="unipayment-advertising__link">
                    {if $unipayment_advertising.backurl}
                        <a href="{$unipayment_advertising.backurl|escape:'htmlall':'UTF-8'}" target="_blank"
                            rel="noopener noreferrer">{l s='ИНФОРМАЦИЯ ЗА ОНЛАЙН ПАЗАРУВАНЕ НА КРЕДИТ!' d='Modules.Unipayment.Shop'}</a>
                    {else}
